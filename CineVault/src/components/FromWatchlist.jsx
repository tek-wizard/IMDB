    ...
    <div className="relative min-h-[30rem] overflow-hidden border-none rounded-tr-[1rem] rounded-br-[1rem]">
      ...
      <div className="relative z-10 flex flex-col justify-center h-full px-12">
        <div className="space-y-6 mt-[10%]">
          <h2 className="text-5xl font-extrabold leading-tight text-white drop-shadow-xl">
            {movieObj?.title}
          </h2>
          <p className="text-lg text-white/90 leading-relaxed max-w-xl line-clamp-4">
            {movieObj?.overview ||
              "No description available for this movie. Stay tuned for updates!"}
          </p>
...
function FromWatchlist() {
  ...
  return (
    <>
      <h1 className="w-full text-center text-white text-3xl font-display">
        Your Watchlist
      </h1>
